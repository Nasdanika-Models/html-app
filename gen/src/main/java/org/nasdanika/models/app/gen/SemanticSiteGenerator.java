...
import org.nasdanika.models.app.emf.ActionProviderAdapterFactory;
import org.nasdanika.models.app.emf.EObjectActionResolver;
...
public class SemanticSiteGenerator extends SiteGenerator {
	...
	public Resource generateActionModel(
		...
		for (EObject semanticElement: semanticModelResource.getContents()) {
			...
			BiFunction<Label, URI, URI> uriResolver = org.nasdanika.models.app.util.Util.uriResolver(action, uriResolverContext);
			...
			if (resolver instanceof EObjectActionResolver) {														
				org.nasdanika.models.app.emf.EObjectActionResolver.Context resolverContext = new org.nasdanika.models.app.emf.EObjectActionResolver.Context() {
