...
public final class Util {
	...
	public static void generateSite(
		...
		BiFunction<Label, URI, URI> uriResolver = org.nasdanika.models.app.util.Util.uriResolver(root, context);		
		generateSite(
				root, 
				principal, 
				activeAction,
	...
	public static void generateSite(
				...
				if (file != null) {
					...
					for (EObject be: bootstrapPage.getBody()) {
						if (be instanceof org.nasdanika.models.app.Page) {
							buildAppPage(root, principal, (Action) activeAction, actionPath, (org.nasdanika.models.app.Page) be, uriResolver, actionContentProvider, progressMonitor);						
						}
					}
		...
		for (EObject child: org.nasdanika.models.app.util.Util.resolveActionReferences(activeAction.getChildren())) {
		...
		if (activeAction instanceof Action) {
			...
			for (EObject navigation: org.nasdanika.models.app.util.Util.resolveActionReferences(theActiveAction.getNavigation())) {
	...
	private static void buildAppPage(
			...
			Action activeAction, 
			List<Label> actionPath,
			org.nasdanika.models.app.Page appPage,
			BiFunction<Label, URI, URI> uriResolver, 
		...
		if (root != null) {
			...
			if (root instanceof Action) {
				List<EObject> rootNavigation = org.nasdanika.models.app.util.Util.resolveActionReferences(((Action) root).getNavigation());
		...
		if (principal != null) {
			...
			if (principal instanceof Action) {
				List<EObject> principalNavigation = org.nasdanika.models.app.util.Util.resolveActionReferences(((Action) principal).getNavigation());
			...
			// Navigation panel
			List<EObject> principalChildren = org.nasdanika.models.app.util.Util.resolveActionReferences(principal.getChildren());
	...
	private static void buildContentPanel(
		...
		if (!rootOrPrincipal) {
			...
			List<EObject> navigation = org.nasdanika.models.app.util.Util.resolveActionReferences(action.getNavigation());
...
//		label.setId(action.getId());		
	...
	private static void generateNavigationPanel(
		...
		if (navigationPanel != null) {
			for (EObject item: org.nasdanika.models.app.util.Util.resolveActionReferences(navigationPanel.getItems())) {
