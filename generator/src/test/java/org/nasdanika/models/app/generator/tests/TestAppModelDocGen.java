package org.nasdanika.models.app.generator.tests;
...
import org.nasdanika.models.app.processors.EcoreGenAppProcessorsFactory;
 ...
 *
 */
public class TestAppModelDocGen {
	...
	public void testGenerateAppModelDoc() throws IOException, DiagnosticException {
		...
		URI baseActionURI = URI.createURI("local://html-app.models.nasdanika.org/");
		...
		Map<EPackage, URI> packageURIMap = Map.ofEntries(
			...
			Map.entry(BootstrapPackage.eINSTANCE, URI.createURI("https://bootstrap.models.nasdanika.org/")),			
			Map.entry(AppPackage.eINSTANCE, baseActionURI)	
		);
				...
				if (element instanceof EObjectNode) {
					...
					if (target == topLevelPackage) {
						...
						if (processor instanceof WidgetFactory) {
							...
							if (topLevelPackage == AppPackage.eINSTANCE) { 							
		...
		File output = new File(actionModelsDir, "app.xmi");
